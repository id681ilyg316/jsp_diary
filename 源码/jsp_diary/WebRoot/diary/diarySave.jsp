...
<script type="text/javascript">
	function checkForm(){
		...
		if(typeId==null||typeId==""){
			document.getElementById("error").innerHTML="请选择日记类别！";
			return false;
		}
		return true;
	}
...
<div class="data_list">
		...
		<form action="diary?action=save" onsubmit="return checkForm()">
			<div>
				<div class="diary_title"><input type="text" id="title"  name="title" value="${diary.title }" class="input-xlarge"  style="margin-top:5px;height:30px;"  placeholder="日记标题..."/></div>
				<div>
